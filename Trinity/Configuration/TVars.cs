...
namespace Trinity
{
    ...
    public static class V
    {
        public static void SetDefaults()
        {
            ...
            Set(new TVar("Barbarian.Rend.MinUseIntervalMillseconds", 3500, "Minimum Delay between uses"));
            ...
            Set(new TVar("SpellDelay.Wizard_FrostNova", 5, "Spell Use Delay/Interval, milliseconds"));
            ...
            Set(new TVar("SpellDelay.Wizard_Teleport", 250, "Spell Use Delay/Interval, milliseconds"));
            Set(new TVar("SpellDelay.Wizard_WaveOfForce", 5, "Spell Use Delay/Interval, milliseconds"));
            ...
            Set(new TVar("SpellDelay.Wizard_Blizzard", 500, "Spell Use Delay/Interval, milliseconds"));
