    ...
    public class QTOpenRiftWrapperTag : OpenRiftTag, IEnhancedProfileBehavior
    {
        ...
        public override void OnStart()
        {
            try
            {
                ...
                if (ZetaDia.Actors.GetActorsOfType<DiaObject>(true).Any(i => i.ACDGuid != 0 && i.IsValid && (i.ActorSNO == RiftPortalSno || i.ActorSNO == GreaterRiftPortalSNO)))
                {
        ...
        private async Task<bool> MainCoroutine()
        {
            ...
            //[22559C94] GizmoType: LootRunSwitch Name: x1_OpenWorld_LootRunObelisk_B-91 ActorSNO: 364715 Distance: 4.497307 Position: <359.9, 262.766, -0.0996094> Barracade: False Radius: 9.874258
        ...
        private Func<ACDItem, bool> ItemMatcherFunc
        {
            get
            {
                ...
                return i => i.IsValid && i.ActorSNO == 408416;
            }
        }
