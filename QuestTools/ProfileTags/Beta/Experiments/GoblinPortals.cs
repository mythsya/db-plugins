...
namespace QuestTools.Helpers
{
    class GoblinPortals
    {
        ...
        public static void Pulse()
        {
            ...
            //if (whymsyportal != null && whymsyportal.IsNearby && !CompletedPortalLocations.Contains(whymsyportal.LevelAreaId))
            //{
            //    // Entrance
            ...
            //    CompletedPortalLocations.Add(whymsyportal.LevelAreaId);
