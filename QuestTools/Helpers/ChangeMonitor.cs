...
namespace QuestTools.Helpers
{
    public class ChangeMonitor
    {
        ...
        public static void CheckForChanges()
        {
            ...
            if (ZetaDia.WorldInfo.IsValid && ZetaDia.CurrentWorldId != _worldId)
            {
            ...
            if (!_somethingChanged || !ZetaDia.IsInGame || ZetaDia.IsLoadingWorld || ZetaDia.Me.Position == Vector3.Zero)
                return;
