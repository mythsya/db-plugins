...
// AUTO-GENERATED on Wed, 26 Aug 2015 04:57:26 GMT
    ...
    public static class Runes
    {
        ...
        public class DemonHunter : FieldCollection<DemonHunter, Rune>
        {
            ...
            public static Rune ShurikenCloud = new Rune
            {
                ...
                RuneIndex = 4,
                SkillIndex = 8,
                ModifiedDuration = TimeSpan.FromSeconds(120),
                ModifiedElement = Element.Physical,
                ModifiedIsDamaging = true,
                Class = ActorClass.DemonHunter
            };
            ...
            /// <summary>
            /// Knockback the first 2 enemies hit.
            /// </summary>
            public static Rune SuppressionFire = new Rune
            {
                Index = 3,
                Name = "Suppression Fire",
                Description = "Knockback the first 2 enemies hit.",
            ...
            /// <summary>
            /// Call a group of 8 Shadow Beasts to plummet from the sky at a targeted location dealing 3800% total weapon damage as Cold over 4 seconds and Freezing enemies hit for 2 seconds.
            /// </summary>
            public static Rune FlyingStrike = new Rune
            {
                Index = 5,
                Name = "Flying Strike",
                Description = "Call a group of 8 Shadow Beasts to plummet from the sky at a targeted location dealing 3800% total weapon damage as Cold over 4 seconds and Freezing enemies hit for 2 seconds.",
        ...
        public class WitchDoctor : FieldCollection<WitchDoctor, Rune>
        {
            ...
            public static Rune DeathIsLife = new Rune
            {
                Index = 3,
                Name = "Death Is Life",
                Description = "Enemies who die while in the area of Grasp of the Dead have a 10% chance to drop a health globe or summon a Zombie Dog.Damage type is changed to Poison.",
            ...
            /// <summary>
            /// Increase your Armor by 30% and reduce the movement speed of harvested enemies by 80% for 5 seconds.
            /// </summary>
            public static Rune Languish = new Rune
            {
                Index = 3,
                Name = "Languish",
                Description = "Increase your Armor by 30% and reduce the movement speed of harvested enemies by 80% for 5 seconds.",
            ...
            /// <summary>
            /// When the Gargantuan encounters an elite enemy or is near 5 enemies, it enrages for 15 seconds gaining: 20% movement speed 35% attack speed 200% Physical damageThis effect cannot occur more than once every 120 seconds. Elite enemies include champions, rares, bosses, and other players.
            /// </summary>
            public static Rune RestlessGiant = new Rune
            {
                Index = 2,
                Name = "Restless Giant",
                Description = "When the Gargantuan encounters an elite enemy or is near 5 enemies, it enrages for 15 seconds gaining: 20% movement speed 35% attack speed 200% Physical damageThis effect cannot occur more than once every 120 seconds. Elite enemies include champions, rares, bosses, and other players.",
            ...
            public static Rune ToadOfHugeness = new Rune
            {
                ...
                Description = "Summon a giant toad that pulls in enemies, briefly swallows them whole, then spits them back out with a layer of goo that deals 750% weapon damage as Poison over 5 seconds and increases all damage taken by 25%.",
                Tooltip = "rune/hex/a",
                TypeId = "a",
                RuneIndex = 0,
                SkillIndex = 16,
            ...
            /// <summary>
            /// Raise a circle of zombies from the ground that traps and attacks nearby enemies for 1000% weapon damage as Physical over 4 seconds.
            /// </summary>
            public static Rune SurroundedByDeath = new Rune
            {
                Index = 3,
                Name = "Surrounded by Death",
                Description = "Raise a circle of zombies from the ground that traps and attacks nearby enemies for 1000% weapon damage as Physical over 4 seconds.",
        ...
        public class Crusader : FieldCollection<Crusader, Rune>
        {
            ...
            /// <summary>
            /// The hammer is made of ice, chilling enemies it passes through and has a 35% chance to explode on impact, dealing 460% weapon damage as Cold and Freezing enemies within 6 yards for 1 seconds.
            /// </summary>
            public static Rune IceboundHammer = new Rune
            {
                Index = 4,
                Name = "Icebound Hammer",
                Description = "The hammer is made of ice, chilling enemies it passes through and has a 35% chance to explode on impact, dealing 460% weapon damage as Cold and Freezing enemies within 6 yards for 1 seconds.",
        ...
        public class Barbarian : FieldCollection<Barbarian, Rune>
        {
            ...
            public static Rune TheMountainsCall = new Rune
            {
                ...
                SkillIndex = 13,
                ModifiedDuration = TimeSpan.FromSeconds(50),
                ModifiedCooldown = TimeSpan.FromSeconds(50),
                ModifiedElement = Element.Lightning,
                Class = ActorClass.Barbarian
            };
            ...
            /// <summary>
            /// Store up to 2 charges of Furious Charge.Furious Charge&#39;s damage turns into Lightning.
            /// </summary>
            public static Rune Dreadnought = new Rune
            {
                Index = 5,
                Name = "Dreadnought",
                Description = "Store up to 2 charges of Furious Charge.Furious Charge&#39;s damage turns into Lightning.",
