...
// AUTO-GENERATED on Thu, 16 Apr 2015 06:47:44 GMT
...
/// <summary>
/// Cooldown: 15 secondsTransform your skin to diamond for 3 seconds, absorbing up to 93337 damage from incoming attacks.
/// </summary>
...
RequiredLevel = 8,
Description = "Cooldown: 15 secondsTransform your skin to diamond for 3 seconds, absorbing up to 93337 damage from incoming attacks.",
...
RequiredLevel = 8,
Description = "Generate: 15 FuryCooldown: 10 secondsLeap into the air, dealing 180% weapon damage to all enemies within 8 yards of your destination and slowing their movement speed by 60% for 3 seconds.",
...
RequiredLevel = 19,
Description = "Cost: 25 FuryCooldown: 60 secondsShake the ground violently, dealing 4200% weapon damage as Fire over 8 seconds to all enemies within 18 yards.",
...
/// <summary>
/// Generate: 20 FuryCooldown: 20 secondsUnleash a rallying cry to increase Armor for you and all allies within 100 yards by 20% for 60 seconds.
/// </summary>
...
RequiredLevel = 28,
Description = "Generate: 20 FuryCooldown: 20 secondsUnleash a rallying cry to increase Armor for you and all allies within 100 yards by 20% for 60 seconds.",
...
/// <summary>
/// Cooldown: 30 secondsCause a massive avalanche of rocks to fall on an area dealing 1600% weapon damage to all enemies caught in its path.Cooldown is reduced by 1 second for every 25 Fury you spend.
/// </summary>
...
RequiredLevel = 61,
Description = "Cooldown: 30 secondsCause a massive avalanche of rocks to fall on an area dealing 1600% weapon damage to all enemies caught in its path.Cooldown is reduced by 1 second for every 25 Fury you spend.",
...
/// <summary>
/// Cooldown: 45 secondsSummon 3 Zombie Dogs from the depths to fight by your side. Each dog deals 30% of your weapon damage as Physical per hit.
/// </summary>
...
RequiredLevel = 4,
Description = "Cooldown: 45 secondsSummon 3 Zombie Dogs from the depths to fight by your side. Each dog deals 30% of your weapon damage as Physical per hit.",
...
/// <summary>
/// Cooldown: 12 secondsDon a spectral mask that horrifies all enemies within 18 yards, causing them to tremor in Fear and be Immobilized for 3 seconds.
/// </summary>
...
RequiredLevel = 8,
Description = "Cooldown: 12 secondsDon a spectral mask that horrifies all enemies within 18 yards, causing them to tremor in Fear and be Immobilized for 3 seconds.",
...
/// <summary>
/// Cooldown: 15 secondsFeed on the life force of up to 5 enemies within 18 yards. Gain 3% Intelligence for each affected enemy. This effect lasts 30 seconds.
/// </summary>
...
RequiredLevel = 9,
Description = "Cooldown: 15 secondsFeed on the life force of up to 5 enemies within 18 yards. Gain 3% Intelligence for each affected enemy. This effect lasts 30 seconds.",
...
/// <summary>
/// Cooldown: 12 secondsLeave your physical body and enter the spirit realm for 2 seconds. While in the spirit realm, your movement is unhindered.This ability does not start its cooldown until after its effects expire.
/// </summary>
...
RequiredLevel = 16,
Description = "Cooldown: 12 secondsLeave your physical body and enter the spirit realm for 2 seconds. While in the spirit realm, your movement is unhindered.This ability does not start its cooldown until after its effects expire.",
...
/// <summary>
/// Cost: 100 ManaBombard an enemy with 4 spirit bolts that deal a total of 425% weapon damage as Cold.
/// </summary>
...
RequiredLevel = 17,
Description = "Cost: 100 ManaBombard an enemy with 4 spirit bolts that deal a total of 425% weapon damage as Cold.",
...
/// <summary>
/// Cooldown: 60 secondsSummon a Gargantuan zombie to fight for you. The Gargantuan attacks for 100% of your weapon damage as Physical.
/// </summary>
...
RequiredLevel = 19,
Description = "Cooldown: 60 secondsSummon a Gargantuan zombie to fight for you. The Gargantuan attacks for 100% of your weapon damage as Physical.",
...
/// <summary>
/// Cooldown: 8 secondsRaise a wall of zombies 28 yards wide from the ground that blocks enemies and attacks them for 1000% weapon damage as Physical over 6 seconds.
/// </summary>
...
RequiredLevel = 28,
Description = "Cooldown: 8 secondsRaise a wall of zombies 28 yards wide from the ground that blocks enemies and attacks them for 1000% weapon damage as Physical over 6 seconds.",
...
/// <summary>
/// Generate: 3 HatredFire a magically imbued arrow that seeks out enemies for 155% weapon damage and has a 35% chance to pierce through them.
/// </summary>
...
RequiredLevel = 1,
Description = "Generate: 3 HatredFire a magically imbued arrow that seeks out enemies for 155% weapon damage and has a 35% chance to pierce through them.",
...
/// <summary>
/// Generate: 3 HatredImbue an arrow with shadow energy that deals 200% weapon damage to the primary enemy and entangles up to 2 enemies, slowing their movement by 60% for 2 seconds.When Entangling Shot hits an enemy, the Slow effect on all entangled enemies is refreshed.
/// </summary>
...
RequiredLevel = 3,
Description = "Generate: 3 HatredImbue an arrow with shadow energy that deals 200% weapon damage to the primary enemy and entangles up to 2 enemies, slowing their movement by 60% for 2 seconds.When Entangling Shot hits an enemy, the Slow effect on all entangled enemies is refreshed.",
...
/// <summary>
/// Generate: 3 HatredShoot out an explosive bola that wraps itself around the enemy. After 1 seconds, the bola explodes dealing 160% weapon damage as Fire to the enemy and an additional 110% weapon damage as Fire to all other enemies within 14 yards.
/// </summary>
...
RequiredLevel = 11,
Description = "Generate: 3 HatredShoot out an explosive bola that wraps itself around the enemy. After 1 seconds, the bola explodes dealing 160% weapon damage as Fire to the enemy and an additional 110% weapon damage as Fire to all other enemies within 14 yards.",
...
/// <summary>
/// Generate: 3 HatredThrow a grenade that bounces and explodes for 160% weapon damage as Fire.
/// </summary>
...
RequiredLevel = 15,
Description = "Generate: 3 HatredThrow a grenade that bounces and explodes for 160% weapon damage as Fire.",
...
/// <summary>
/// Cost: 14 DisciplineDraw in the power of the shadows, gaining 16093 Life per Hit for 5 seconds.
/// </summary>
...
RequiredLevel = 16,
Description = "Cost: 14 DisciplineDraw in the power of the shadows, gaining 16093 Life per Hit for 5 seconds.",
...
/// <summary>
/// Cost: 40 HatredFire a cluster arrow that explodes for 550% weapon damage as Fire into a series of 4 additional grenades that each explode for 220% weapon damage as Fire.
/// </summary>
...
RequiredLevel = 27,
Description = "Cost: 40 HatredFire a cluster arrow that explodes for 550% weapon damage as Fire into a series of 4 additional grenades that each explode for 220% weapon damage as Fire.",
...
/// <summary>
/// Cooldown: 90 secondsTurn into the physical embodiment of Vengeance for 15 seconds. Side Guns: Gain 4 additional piercing shots for 60% weapon damage each on every attack. Homing Rockets: Shoot 4 rockets at nearby enemies for 40% weapon damage each on every attack.
/// </summary>
...
RequiredLevel = 61,
Description = "Cooldown: 90 secondsTurn into the physical embodiment of Vengeance for 15 seconds. Side Guns: Gain 4 additional piercing shots for 60% weapon damage each on every attack. Homing Rockets: Shoot 4 rockets at nearby enemies for 40% weapon damage each on every attack.",
