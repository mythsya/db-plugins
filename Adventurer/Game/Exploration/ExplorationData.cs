...
namespace Adventurer.Game.Exploration
{
    public static class ExplorationData
    {
        ...
        //{
        //    get { return OpenWorldIds.Contains(AdvDia.CurrentWorldId) ? 8 : 4; }
        //}
        ...
        public static float ExplorationNodeBoxSize
        {
            get
            {
                ...
                //return OpenWorldIds.Contains(AdvDia.CurrentWorldId) ? 30 : 15;
            }
        }
        ...
        public static float ExplorationNodeBoxTolerance
        {
            get
            {
                ...
                //return OpenWorldIds.Contains(AdvDia.CurrentWorldId) ? 0.1f : 0.03f;
            }
        }
