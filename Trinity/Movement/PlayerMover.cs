...
namespace Trinity.DbProvider
{
    ...
    public class PlayerMover : IPlayerMover
    {
        ...
        internal static bool GetIsBlocked()
        {
            ...
            if (ZetaDia.Me.Movement != null && ZetaDia.Me.Movement.IsValid && ZetaDia.Me.Movement.SpeedXY > 0.5)
            {
            ...
            var testPoints = MathUtil.GetCirclePoints(10, 10f, ZetaDia.Me.Position).Where(NavHelper.CanRayCast).ToList();

            var blocked = testPoints.All(p => testObjects.Any(o => MathUtil.PositionIsInCircle(p, o.Position, o.Radius/2)));            
