...
namespace Trinity.Config.Combat
{
    ...
    public class CrusaderSetting : ITrinitySetting<CrusaderSetting>, IAvoidanceHealth, INotifyPropertyChanged
    {
        ...
        [DataMember(IsRequired = false)]
        [DefaultValue(15f)]
        public float SteedChargeMinRange
        {
            get
            {
                return _SteedChargeMinRange;
            }
            set
            {
                if (_SteedChargeMinRange != value)
                {
                    _SteedChargeMinRange = value;
                    OnPropertyChanged("SteedChargeMinRange");
                }
            }
        }
