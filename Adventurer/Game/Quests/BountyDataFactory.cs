...
namespace Adventurer.Game.Quests
{
    public static class BountyDataFactory
    {
        ...
        {
            var bounty = Bounties.FirstOrDefault(b => b.QuestId == questId);
            //if (bounty != null)
            //{
            //    bounty.Reset();
            //}
...
//                        new EnterLevelAreaCoroutine(375350,261712,338930,-660641889 ,376027),
        ...
        private static void AddCustomBounties()
        {
            ...
            Bounties.Add(new BountyData
            {
                ...
                Coroutines = new List<ISubroutine>
                {
                    new EnterLevelAreaCoroutine(0, 71150, 154587, -1861222194, 176002),
                ...
                Coroutines = new List<ISubroutine>
                    {
                        ...
                        new ClearAreaForNSecondsCoroutine (409897, 60, 364559,0,200)
                    }
            });
        }
