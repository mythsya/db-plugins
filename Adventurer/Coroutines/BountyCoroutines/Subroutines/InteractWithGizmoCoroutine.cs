...
namespace Adventurer.Coroutines.BountyCoroutines.Subroutines
{
    public class InteractWithGizmoCoroutine : IBountySubroutine
    {
        ...
        public InteractWithGizmoCoroutine(int questId, int worldId, int actorId, int marker, int interactAttemps = 1, int secondsToSleepAfterInteraction = 1, int secondsToTimeout = 10)
        {
            _questId = questId;
            _worldId = worldId;
            _actorId = actorId;
