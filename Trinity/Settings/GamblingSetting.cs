...
namespace Trinity.Config
{
    ...
    public class GamblingSetting : ITrinitySetting<GamblingSetting>, INotifyPropertyChanged
    {
        ...
        public List<Town.VendorSlot> SelectedGambleSlots
        {
            get
            {
                var list = new List<Town.VendorSlot>();
                if (TwoHandItem) list.Add(Town.VendorSlot.TwoHandItem);
                if (OneHandItem) list.Add(Town.VendorSlot.OneHandItem);
                if (Mojo) list.Add(Town.VendorSlot.Mojo);
                if (Quiver) list.Add(Town.VendorSlot.Quiver);
                if (Orb) list.Add(Town.VendorSlot.Orb);
                if (Helm) list.Add(Town.VendorSlot.Helm);
                if (Gloves) list.Add(Town.VendorSlot.Gloves);
                if (Boots) list.Add(Town.VendorSlot.Boots);
                if (Chest) list.Add(Town.VendorSlot.Chest);
                if (Belt) list.Add(Town.VendorSlot.Belt);
                if (Shoulders) list.Add(Town.VendorSlot.Shoulder);
                if (Pants) list.Add(Town.VendorSlot.Pants);
                if (Bracers) list.Add(Town.VendorSlot.Bracers);
                if (Shield) list.Add(Town.VendorSlot.Shield);
                if (Ring) list.Add(Town.VendorSlot.Ring);
                if (Amulet) list.Add(Town.VendorSlot.Amulet);
