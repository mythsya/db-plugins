    ...
    public class GenericBountyCoroutine : BountyCoroutine
    {
        ...
        private async Task<bool> InProgress()
        {
            ...
            if (step == null)
            {
                ...
                //new MoveToObjectCoroutine(347558,AdvDia.CurrentWorldId,433670),
                //new InteractWithGizmoCoroutine(347558,AdvDia.CurrentWorldId,433670,0,5),
            ...
            //    if (enterLevelAreaStep.SourceWorldId != AdvDia.CurrentWorldId ||
            //        enterLevelAreaStep.DestinationWorldId != AdvDia.CurrentWorldId)
            //    {
            //        Bounty.Reset();
            //        Reset();
