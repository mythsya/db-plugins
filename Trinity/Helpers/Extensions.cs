...
namespace Trinity.Helpers
{
    ...
    public static class Extensions
    {
        ...
        public static TrinityItemQuality GetTrinityItemQuality(this ACDItem item)
        {
            ...
            switch (itemQuality)
            {
                case Zeta.Game.Internals.Actors.ItemQuality.Invalid:
                    return TrinityItemQuality.None;
                case Zeta.Game.Internals.Actors.ItemQuality.Inferior:
                case Zeta.Game.Internals.Actors.ItemQuality.Normal:
                case Zeta.Game.Internals.Actors.ItemQuality.Superior:
                    return TrinityItemQuality.Common;
                case Zeta.Game.Internals.Actors.ItemQuality.Magic1:
                case Zeta.Game.Internals.Actors.ItemQuality.Magic2:
                case Zeta.Game.Internals.Actors.ItemQuality.Magic3:
                    return TrinityItemQuality.Magic;
                case Zeta.Game.Internals.Actors.ItemQuality.Rare4:
                case Zeta.Game.Internals.Actors.ItemQuality.Rare5:
                case Zeta.Game.Internals.Actors.ItemQuality.Rare6:
                    return TrinityItemQuality.Rare;
                case Zeta.Game.Internals.Actors.ItemQuality.Legendary:
                case Zeta.Game.Internals.Actors.ItemQuality.Special:
                default:
        ...
        {
            if (item == null)
                return Zeta.Game.Internals.Actors.ItemQuality.Invalid;
            if (!item.IsValid)
                return Zeta.Game.Internals.Actors.ItemQuality.Invalid;
            ...
            switch (linkColor)
            {
                case "{c:ff00ff00}": // Green
                    qualityResult = Zeta.Game.Internals.Actors.ItemQuality.Legendary;
                    break;
                case "{c:ffff8000}": // Orange
                    qualityResult = Zeta.Game.Internals.Actors.ItemQuality.Legendary;
                    break;
                case "{c:ffffff00}": // Yellow
                    qualityResult = Zeta.Game.Internals.Actors.ItemQuality.Rare4;
                    break;
                case "{c:ff6969ff}": // Magic Blue 
                    qualityResult = Zeta.Game.Internals.Actors.ItemQuality.Magic1;
                    break;
                case "{c:ffffffff}": // White
                    qualityResult = Zeta.Game.Internals.Actors.ItemQuality.Normal;
                    break;
                ...
                case "{c:ffc236ff}": // Purple
                    qualityResult = Zeta.Game.Internals.Actors.ItemQuality.Special;
                    break;
                case "{c:ff888888}": // Gray
                    qualityResult = Zeta.Game.Internals.Actors.ItemQuality.Inferior;
                    break;
                case "":
