...
//        private const ulong partyLeaderBossDelineHash = 0x285AFB08A7810F52;
...
//                return;
//            if (!IsPartyDialogVisible && Trinity.Player.IsInGame && SafeClickElement(ConversationSkipButton, "Conversation Button"))
//                return;
...
//            {
//                var declineInBounty = Trinity.Settings.Combat.Misc.FollowerBossFightDialogMode == MiscCombatSetting.FollowerBossFightMode.DeclineInBounty && ZetaDia.ActInfo.ActiveBounty != null;
//                var alwaysDecline = Trinity.Settings.Combat.Misc.FollowerBossFightDialogMode == MiscCombatSetting.FollowerBossFightMode.AlwaysDecline;

//                if (declineInBounty || alwaysDecline)
//                {
//                    if (Trinity.Player.IsInGame && SafeClickElement(PartyFollowerBossDecline, "Party Follower Boss Decline", true))
//                        return;
//                }
//            }
//            else 
...
//                return;
//            if (!IsPartyDialogVisible && SafeClickElement(GenericOK, "GenericOK"))
//                return;
